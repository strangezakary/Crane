...
#include UE_INLINE_GENERATED_CPP_BY_NAME(CameraCalibrationSettings)
...
UCameraCalibrationSettings::UCameraCalibrationSettings()
{
	...
	// Default materials to use for the Brown-Conrady U-D lens model
	DefaultUndistortionDisplacementMaterials.Add(UBrownConradyUDLensDistortionModelHandler::StaticClass(), TSoftObjectPtr<UMaterialInterface>(FSoftObjectPath(TEXT("/CameraCalibrationCore/Materials/M_BrownConradyUDUndistortionDisplacementMap.M_BrownConradyUDUndistortionDisplacementMap"))));
	DefaultDistortionDisplacementMaterials.Add(UBrownConradyUDLensDistortionModelHandler::StaticClass(), TSoftObjectPtr<UMaterialInterface>(FSoftObjectPath(TEXT("/CameraCalibrationCore/Materials/M_BrownConradyUDDistortionDisplacementMap.M_BrownConradyUDDistortionDisplacementMap"))));
	DefaultDistortionMaterials.Add(UBrownConradyUDLensDistortionModelHandler::StaticClass(), TSoftObjectPtr<UMaterialInterface>(FSoftObjectPath(TEXT("/CameraCalibrationCore/Materials/M_DistortionPostProcess.M_DistortionPostProcess"))));

	// Default materials to use for the Brown-Conrady D-U lens model
	DefaultUndistortionDisplacementMaterials.Add(UBrownConradyDULensDistortionModelHandler::StaticClass(), TSoftObjectPtr<UMaterialInterface>(FSoftObjectPath(TEXT("/CameraCalibrationCore/Materials/M_BrownConradyDUUndistortionDisplacementMap.M_BrownConradyDUUndistortionDisplacementMap"))));
	DefaultDistortionDisplacementMaterials.Add(UBrownConradyDULensDistortionModelHandler::StaticClass(), TSoftObjectPtr<UMaterialInterface>(FSoftObjectPath(TEXT("/CameraCalibrationCore/Materials/M_BrownConradyDUDistortionDisplacementMap.M_BrownConradyDUDistortionDisplacementMap"))));
	DefaultDistortionMaterials.Add(UBrownConradyDULensDistortionModelHandler::StaticClass(), TSoftObjectPtr<UMaterialInterface>(FSoftObjectPath(TEXT("/CameraCalibrationCore/Materials/M_DistortionPostProcess.M_DistortionPostProcess"))));
