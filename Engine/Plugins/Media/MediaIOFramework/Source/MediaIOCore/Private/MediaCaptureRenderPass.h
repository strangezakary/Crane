...
namespace UE::MediaCapture
{
	...
	struct FRenderPass
	{
		...
		/**
		 * Delegate invoked to query whether the pass should be executed.
		 */
		DECLARE_DELEGATE_RetVal_TwoParams(bool, FShouldExecutePass, const UE::MediaCaptureData::FCaptureFrameArgs& /*Args*/, FRDGViewableResource* /*InputResource*/);
		FShouldExecutePass ShouldExecutePassDelegate;
