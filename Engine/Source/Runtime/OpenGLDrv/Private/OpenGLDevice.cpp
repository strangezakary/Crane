...
#if PLATFORM_ANDROID
#include "Android/AndroidJniBitmapRendererLegacy.h"
...
void JNICALL UE::Jni::FBitmapRendererLegacy::nativeClearCachedAttributeState(JNIEnv* jenv, jobject thiz, jint PositionAttrib, jint TexCoordsAttrib)
{
...
#undef LOG_AND_GET_GL_INT_TEMP
	...
	if (PLATFORM_DESKTOP)
	{
		...
		SetupTextureFormat( PF_BC6H,			FOpenGLTextureFormat( GL_COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT, GL_COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT, GL_RGB, GL_HALF_FLOAT, true, false));
