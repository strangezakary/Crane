...
public:
	...
	static bool RequiresWaitingForFrameCompletionEvent() { return bRequiresWaitingForFrameCompletionEvent; }
	...
	static bool RequiresMergedDepthStencilLayout() { return bRequiresMergedRenderPassDepthStencilLayout; }
