...
const FPropertyDefinition* FPropertyRegistry::FindPropertyDefinition(FComponentTypeID ComponentTypeID) const
{
	return Algo::FindBy(Properties, ComponentTypeID, &FPropertyDefinition::PropertyType);
}
