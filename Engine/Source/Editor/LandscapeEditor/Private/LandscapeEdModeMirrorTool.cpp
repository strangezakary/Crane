...
public:
	...
	{
		return ELandscapeToolTargetTypeFlags::Heightmap;
	}
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				LandscapeEdit.SetAlphaData(LayerInfo, DestMinX, DestMinY, DestMaxX, DestMaxY, &DestWeightData[0], DestSizeX, ELandscapeLayerPaintingRestriction::None, /*bWeightAdjust = */false,  /*bTotalWeightAdjust = */false);
